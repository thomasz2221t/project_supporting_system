...
@Mapper(componentModel = "spring", injectionStrategy = InjectionStrategy.CONSTRUCTOR, uses = {StudentGroupMapper.class, MeetingMapper.class, TopicMapper.class})
public interface GroupMapper {

    @Mapping(target = "topic", source = "topic", qualifiedByName = "mapDtoToEntity")
    Group mapDtoToEntity(GroupDto groupDto);

    @Mapping(target = "topic", source = "topic", qualifiedByName = "mapEntityToDtoIgnoreGroup")
